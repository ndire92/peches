...
class DPAS(ModelForm):
    ...
    class Meta:
        ...
        fields = ['TypeAssurancPech', 'BesoinFormatPech', 'ActeurSensibilisePech', 'ActeurFormatPech',
                  'BesoinSensibilisePech', 'OffreAssureExistPech', 'ContraintGlobPech', 'ContrainMajFilier']
